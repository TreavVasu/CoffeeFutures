...
```bash
.venv/bin/python project/scripts/fill_cot_forward_daily.py
```

## Train

```bash
.venv/bin/python project/scripts/train_arabica_model.py
```
...
- `project/artifacts/models/arabica_returns_model.joblib`
- `project/artifacts/outputs/arabica_model_metrics.json`
- `project/artifacts/outputs/arabica_holdout_predictions.csv`
- `project/artifacts/plots/regression_metrics.png`
- `project/artifacts/plots/classification_accuracy_metrics.png`
- `project/artifacts/plots/roc_curve.png`
- `project/artifacts/plots/actual_vs_predicted_returns.png`
- `project/artifacts/plots/real_vs_predicted_price.png`
- `project/artifacts/plots/feature_importance.png`
- `project/artifacts/plots/prediction_error_drift.png`
- `project/artifacts/plots/rolling_direction_accuracy.png`
- `project/artifacts/plots/feature_drift_top.png`
- `project/artifacts/plots/cot_target_correlation.png`
- `project/artifacts/plots/cot_error_correlation.png`
- `project/artifacts/plots/cot_drift_vs_error_correlation.png`
- `project/artifacts/outputs/feature_drift_cot_correlation_report.csv`
- `project/artifacts/outputs/worst_error_dates_with_drift_context.csv`
- `project/artifacts/outputs/news_context_by_error_date.csv`
- `project/artifacts/outputs/news_articles_by_error_date.csv`
- `project/artifacts/plots/news_impact_vs_return.png`
- `project/artifacts/plots/news_strength_vs_model_error.png`
- `project/artifacts/plots/news_article_count_by_error_date.png`

## Predict

```bash
.venv/bin/python project/scripts/predict_arabica_returns.py --latest-rows 10
```

This loads the saved model and writes `project/artifacts/outputs/latest_arabica_predictions.csv`.
...
```bash
.venv/bin/python project/scripts/refresh_weather_cache.py
```
...
```bash
.venv/bin/python project/scripts/news_context_analysis.py --top-n 25 --max-articles 8
```
