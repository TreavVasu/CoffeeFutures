...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--worst-dates", default="project/artifacts/outputs/worst_error_dates_with_drift_context.csv")
    parser.add_argument("--output-dir", default="project/artifacts/outputs")
    parser.add_argument("--plots-dir", default="project/artifacts/plots")
