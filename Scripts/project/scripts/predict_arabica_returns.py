...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model", default="Scripts/project/artifacts/models/arabica_returns_model.joblib")
    parser.add_argument("--output", default="Scripts/project/artifacts/outputs/latest_arabica_predictions.csv")
