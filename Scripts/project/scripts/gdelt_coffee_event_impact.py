...
DEFAULT_ZIP = ROOT / "Scripts" / "EventsData" / "Zip" / "2000.zip"
DEFAULT_PRICE_PATH = ROOT / "data" / "centralData" / "yahoo_cot_full_outer_by_date_cot_ffill.csv"
DEFAULT_DATE_SOURCE = ROOT / "Scripts" / "project" / "artifacts" / "outputs" / "yahoo_price_drift_events.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--zip-path", default=str(DEFAULT_ZIP), help="GDELT yearly zip, e.g. Scripts/EventsData/Zip/2000.zip")
